import type { BonusRecord, ExtractionResult, Mismatch, Priority } from "./types.js";

const FIELD_PRIORITY: Record<string, Priority> = {
...
export function compareBonusData(ours: BonusRecord, extracted: ExtractionResult): Mismatch[] {
  ...
  for (const field of COMPARE_FIELDS) {
    ...
    const ourValue = ours[field as keyof BonusRecord];
    ...
    if (ourValue === null && siteValue === null) continue;
